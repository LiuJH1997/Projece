import '../css/THRTiptag.css';
import corSvg from '../imgs/correct.svg';
import errSvg from '../imgs/error.svg';
import dbtSvg from '../imgs/doubt.svg';
import msgSvg from '../imgs/message.svg';
import warSvg from '../imgs/warning.svg';
import clsSvg from '../imgs/close.svg';
...
class THRTipTag {
    ...
    getHtml(config){
        var htmlStr = "";
        htmlStr +=  "<THR-tiptag><tiptag-wrap>" + "<tiptag-img>" +
                    imgObj[config.alertType] +"</tiptag-img>"+
                    "<tiptag-closeBtn>" + clsSvg + "</tiptag-closeBtn>" +
